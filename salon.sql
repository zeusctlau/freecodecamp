...
INSERT INTO public.appointments VALUES (1, 1, 1, 'SERVICE_TIME');
...
--
-- Name: customers customers_phoe_key; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.customers
    ADD CONSTRAINT customers_phoe_key UNIQUE (phone);
